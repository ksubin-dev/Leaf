package com.subin.leafy.data.datasource.remote.auth
...
class FirebaseAuthDataSourceImpl(
    ...
    override suspend fun login(email: String, password: String): DataResourceResult<Unit> {
        return try {
    ...
    override suspend fun signUp(email: String, password: String): DataResourceResult<Unit> {
        return try {
