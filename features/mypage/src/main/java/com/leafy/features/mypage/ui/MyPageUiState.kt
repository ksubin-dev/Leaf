...
data class MyPageUiState(
    ...
    val currentMonth: YearMonth @RequiresApi(Build.VERSION_CODES.O)
    get() = YearMonth.from(selectedDateTime)
    val selectedDay: Int @RequiresApi(Build.VERSION_CODES.O)
    get() = selectedDateTime.dayOfMonth
    val selectedMonth: Int @RequiresApi(Build.VERSION_CODES.O)
    get() = selectedDateTime.monthValue
    val selectedYear: Int @RequiresApi(Build.VERSION_CODES.O)
