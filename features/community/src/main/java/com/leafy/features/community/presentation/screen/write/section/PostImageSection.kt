    ...
    Box(
        ...
        if (selectedUris.isNotEmpty()) {
            ...
            Row(
                ...
                IconButton(
                    onClick = singleClick { onAddImage() },
            ...
            IconButton(
                onClick = singleClick { onRemoveImage(selectedUris.first()) },
            ...
            Column(
                ...
                Button(onClick = singleClick { onAddImage() }, modifier = Modifier.padding(top = 16.dp)) {
                    Text("앨범 열기")
                }
            }
        }
