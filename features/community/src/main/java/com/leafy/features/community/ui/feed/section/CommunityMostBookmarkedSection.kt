...
import com.leafy.features.community.ui.component.CommunityCompactCard
...
fun CommunityMostBookmarkedSection(
    ...
    onMoreClick: () -> Unit // 더보기 클릭 시 이동할 액션
) {
    // 데이터가 없으면 섹션 자체를 숨김 (선택 사항)
    ...
    Column(
        ...
        LeafySectionHeader(
            title = "가장 많이 저장된 노트",
            onMoreClick = onMoreClick // 더보기 클릭 이벤트 연결
        )
